...
public:
    ...
    void setSdPlay(bool state) {play_sd_music = state;}//是否是播放SD卡音乐
    virtual bool SetMusicImage(lv_img_dsc_t* image){return false;}
    virtual void UpdateMusicDisplay(){};

    virtual void set_clock_text(const std::string& song_name){};
